...
module Grip
  module Handlers
    class Static < HTTP::StaticFileHandler
      ...
      private def serve_file(context, path : String, mime_type : String? = nil)
        config = static_config
      ...
      private def add_response_headers(context : HTTP::Server::Context)
      ...
      private def next_multipart?(context)
      ...
      private def gzip_encoding(context, file)
      ...
      private def deflate_endcoding(context, file)
      ...
      private def multipart(file, context)
